# chocolate_insoghts_powerBI_Dashboard
A dashboard to give insights on a chocolate company's sales
...
Shipment Analysis
Distribution of shipments over time with performance indicators
Sales Channel & Category Insights
Segmentation by product types (Bars, Bites, Other)
Regional filters (Australia, Canada, India, etc.)
Salesperson Performance
Individual-level breakdown of:
Sales
Profit
Profit %
LBS %
